            ...
            <div className='relative w-full h-full overflow-auto mb-2 noscroll flex flex-col gap-4'>
                <div className='flex justify-between items-center w-full pb-4 border-b border-login-800/50 mb-2'>
                    <span className={`text-xs font-medium px-3 py-1 rounded-full border 
                        ${card.answers.length > 1 ? 'bg-login-800 text-login-100 border-login-700' :
            'bg-login-950 text-login-400 border-login-800'}`}>
                ...
                <div className='mb-6'>
                    ...
                    <div className='text-lg leading-relaxed text-login-200 [&_h1]:text-2xl [&_h1]:font-bold [&_h1]:text-login-50
                        [&_h1]:mb-4 [&_h2]:text-xl [&_h2]:font-bold [&_h2]:text-login-50 [&_h2]:mb-3 [&_p]:mb-4 [&_ul]:list-disc
                        [&_ul]:pl-5 [&_ul]:mb-4 [&_ol]:list-decimal [&_ol]:pl-5 [&_ol]:mb-4 [&_strong]:text-login-50 [&_strong]:font-bold
                        [&_code]:bg-login-950 [&_code]:px-1.5 [&_code]:py-0.5 [&_code]:rounded-md [&_code]:text-login-100
                        [&_code]:font-mono [&_code]:text-sm [&_pre]:bg-login-950 [&_pre]:p-4 [&_pre]:rounded-lg [&_pre]:overflow-x-auto
                        [&_pre]:mb-4 [&_a]:text-blue-400 [&_a]:underline hover:[&_a]:text-blue-300'
                    >
                        <Markdown
                            displayEditor={false}
                            handleDisplayEditor={() => {}}
