...
export default async function CourseList() {
    ...
    if ('error' in courses) {
        return (
            <div className='col-span-2 bg-login-100/10 backdrop-blur-md border border-login-100/20 rounded-2xl
                shadow-lg p-8 px-100 w-full max-w-md text-center gap-6 grid place-items-center self-center'
            >
