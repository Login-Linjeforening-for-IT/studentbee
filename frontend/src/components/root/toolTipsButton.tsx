...
export default function ToolTipsButton() {
    ...
    return (
        <button
            className='hidden lg:flex w-full p-3 bg-login-900 rounded-xl cursor-pointer border border-login-800/50
                hover:bg-login-800 transition-colors items-center shadow-sm'
            onClick={display}
        >
