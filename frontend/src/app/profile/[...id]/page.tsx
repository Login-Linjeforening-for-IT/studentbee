import Self from '@parent/src/components/profile/userClient'
import CourseList from '@parent/src/components/root/courses'
import { getUser } from '@parent/src/utils/fetch'
...
export default async function Profile(props: { params: Promise<{ id: string[] }> }) {
    ...
    return (
        <div className='grid grid-cols-10 w-full h-full rounded-xl gap-8'>
            ...
            <div className='w-full h-full grid place-items-center bg-login-900 rounded-xl col-span-8'>
