        ...
        <div className='bg-darker md:p-2 rounded-xl'>
            <div className='grid grid-cols-2 gap-2 justify-items-center pb-2'>
                <Link
                    ...
                    className={`${isStudy ? 'bg-normal' : 'bg-light'} w-full rounded-lg px-2 content-center text-almostbright flex text-lg items-center`}
                >
                ...
                <Link
                    ...
                    className={`${isStudy ? 'bg-light' : 'bg-normal'} w-full rounded-lg px-2 text-almostbright flex text-lg items-center`}
                >
